...
std::vector<Aeroplane*> Fleet::instantiate_fleet(int number_of_planes) {
	...
	Aeroplane *f12 = new Fighter_Aircraft("F12", 1, 3, 18.3, 1812.2, 2329.2, 6.5);
	...
	Aeroplane *hercules =  new Fighter_Aircraft("Lockheed C-130 Hercules", 1, 7, 20, 3030.2, 7200, 12);
	Aeroplane *antonov = NULL;
    
    if (number_of_planes > 6) {
        Aeroplane *mryia_antonov = new Jet_Plane("Antonov An-225", 1280, 8, 13, 12001.32, 460.80, "Mryia Cargo");
